...
% set(gca,'YTickLabel','')
% colorbar
% annotation('textbox', [0 0.9 1 0.1], 'String', 'Total density', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% axes(h(4));
...
% set(gca,'YTickLabel','')
% colorbar
% annotation('textbox', [0 0.665 1 0.1], 'String', 'N_2 concentration', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% axes(h(6));
...
% set(gca,'YTickLabel','')
% colorbar
% annotation('textbox', [0 0.4 1 0.1], 'String', 'O concentration', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% axes(h(8));
...
% set(gca,'YTickLabel','')
% colorbar
% annotation('textbox', [0 0.16 1 0.1], 'String', 'He concentration', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% d = 180;
% t = linspace(0,24, M);
% 
...
% plot(t, c_N2);
% xlabel('Time');
% annotation('textbox', [0 0.9 1 0.1], 'String', 'N_2 concentration (particles/cm^3)', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% subplot(4,2,4);
% plot(t, c_O);
% xlabel('Time');
% annotation('textbox', [0 0.675 1 0.1], 'String', 'O concentration (particles/cm^3)', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% subplot(4,2,6);
% plot(t, c_He);
% xlabel('Time');
% annotation('textbox', [0 0.45 1 0.1], 'String', 'He concentration (particles/cm^3)', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% subplot(4,2,8);
% plot(t, rho);
% xlabel('Time');
% annotation('textbox', [0 0.225 1 0.1], 'String', 'Total density (g/cm^3)', 'EdgeColor', 'none', 'HorizontalAlignment', 'center', 'Fontsize', 15);
% 
% % high solar activity
% 
% k = 2;
